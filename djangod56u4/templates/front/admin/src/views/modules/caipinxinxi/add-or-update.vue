<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="菜品编号" prop="caipinbianhao">
					<el-input v-model="ruleForm.caipinbianhao" placeholder="菜品编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.caipinbianhao" label="菜品编号" prop="caipinbianhao">
					<el-input v-model="ruleForm.caipinbianhao" placeholder="菜品编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="菜品分类" prop="caipinfenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="菜品分类" prop="caipinfenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="食材主料" prop="shicaizhuliao">
					<el-input v-model="ruleForm.shicaizhuliao" placeholder="食材主料" clearable  :readonly="ro.shicaizhuliao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="食材主料" prop="shicaizhuliao">
					<el-input v-model="ruleForm.shicaizhuliao" placeholder="食材主料" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.caipinjieshao" label="菜品介绍" prop="caipinjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.caipinjieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shicaizhuliao'){
							this.ruleForm.shicaizhuliao = obj[o];
							this.ro.shicaizhuliao = true;
							continue;
						}
						if(o=='caipinjieshao'){
	...
	this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../djangod56u4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
