...
<div class="recommend" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"8px","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","justifyContent":"space-between"}'>
    ...
    <div class="title" :style='{"width":"auto","padding":"0px","margin":"0px ","lineHeight":"54px","textAlign":"left","order":"0"}'>
		<span :style='{"padding":"10px","borderColor":"#55b44b","fontSize":"32px","color":"#000","borderStyle":"solid","borderWidth":" 0 0 5px 0"}'>菜品信息推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"0px","margin":"20px 0 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto","order":"2"}'>
		<div :style='{"border":"1px solid #bee4cc","padding":"4px","margin":"8px 0","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"19%","position":"relative","height":"auto"}' v-for="(item,index) in caipinxinxiRecommend" :key="index" @click="toDetail('caipinxinxiDetail', item)" class="list-item animation-box">
			<img :style='{"width":"100%","objectFit":"cover","borderRadius":"0","display":"block","height":"220px"}' v-if="item.tupian.substr(0,4)=='http'" :src="item.tupian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","objectFit":"cover","borderRadius":"0","display":"block","height":"220px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto","borderColor":"#e1f6e9","color":"#333","background":"#f1fdf5","borderWidth":"0 0 1px 0","display":"block","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}'>菜品名称:{{item.caipinmingcheng}}</div>
			<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto","borderColor":"#e1f6e9","color":"#333","background":"#f1fdf5","borderWidth":"0 0 1px 0","display":"block","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}'>菜品分类:{{item.caipinfenlei}}</div>
			<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto","borderColor":"#e1f6e9","color":"#333","background":"#f1fdf5","borderWidth":"0 0 1px 0","display":"block","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}'>口味:{{item.kouwei}}</div>
		</div>
	</div>
	...
	<div @click="moreBtn('caipinxinxi')" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0","textAlign":"center","display":"block","float":"right","borderRadius":"30px","background":"#3db769","width":"auto","lineHeight":"40px","height":"40px","order":"0"}'>
...
<div class="lists" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","borderRadius":"8px","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"block","position":"relative","justifyContent":"space-between"}'>
	...
	<div class="title" :style='{"padding":"0px","margin":"0","textAlign":"left","background":"0","width":"auto","lineHeight":"54px","order":"1"}'>
	  <span :style='{"padding":"10px","borderColor":"#55b44b","fontSize":"32px","color":"#000","borderStyle":"solid","borderWidth":" 0 0 5px 0"}'>菜品信息展示</span>
	</div>
	...
	<div class="list list3 index-pv1">
		<div class="swiper-container" id="listscaipinxinxi" :style='{"width":"100%","padding":"10px","margin":"20px 0 0 0","background":"#fff","height":"auto","order":"4"}'>
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"1px solid #bee4cc","cursor":"pointer","padding":"4px","borderRadius":"4px","background":"#fff","fontSize":"0","position":"relative"}' v-for="(item,index) in caipinxinxiList" :key="index" @click="toDetail('caipinxinxiDetail', item)">
					<img :name="item.id" :style='{"border":"0","width":"100%","height":"220px"}' v-if="item.tupian.substr(0,4)=='http'" :src="item.tupian.split(',')[0]" alt="" />
					<img :name="item.id" :style='{"border":"0","width":"100%","height":"220px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
					<div class="name line1" :style='{"padding":"0 10px","borderColor":"#e1f6e9","color":"#333","background":"#f1fdf5","borderWidth":"0 0 1px 0","fontSize":"14px","lineHeight":"32px","borderStyle":"solid"}'>菜品名称:{{item.caipinmingcheng}}</div>
					<div class="name line1" :style='{"padding":"0 10px","borderColor":"#e1f6e9","color":"#333","background":"#f1fdf5","borderWidth":"0 0 1px 0","fontSize":"14px","lineHeight":"32px","borderStyle":"solid"}'>菜品分类:{{item.caipinfenlei}}</div>
					<div class="name line1" :style='{"padding":"0 10px","borderColor":"#e1f6e9","color":"#333","background":"#f1fdf5","borderWidth":"0 0 1px 0","fontSize":"14px","lineHeight":"32px","borderStyle":"solid"}'>口味:{{item.kouwei}}</div>
            </div>
        </div>
			<!-- 如果需要导航按钮 -->
	...
	<div @click="moreBtn('caipinxinxi')" :style='{"border":"0","padding":"0 24px","margin":"0","textAlign":"center","display":"block","right":"20px","borderRadius":"30px","top":"20px","background":"#3db769","width":"auto","lineHeight":"40px","position":"absolute","height":"40px","order":"2"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"14px"}'>查看更多</span>
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          autoSortUrl = "caipinxinxi/autoSort";
			...
			this.$http.get('caipinxinxi/list', {params: {
				page: 1,
				limit: 8,
			}}).then(res => {
				if (res.data.code == 0) {
					...
					this.$nextTick(() => {
						new Swiper ('#listscaipinxinxi', options)
					})
